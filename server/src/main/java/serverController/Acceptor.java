...
/**
 * Listens for incoming client connections on a specified port and hands them off to the {@link
 * Server}.
 *
 * <p>Runs in its own thread, continuously accepting new sockets until terminated.
 *
 * @version 1.0
 * @created April 2025
 */
public class Acceptor implements Runnable {
  ...
  /**
   * Main loop: opens the ServerSocket and accepts new client connections. Each accepted socket is
   * passed to {@link Server#addConnection(Socket)}.
   */
  @Override
  public void run() {
