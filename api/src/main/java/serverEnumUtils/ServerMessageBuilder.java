...
/**
 * Builder for formatting outgoing server messages according to the text‐based protocol. Each method
 * prepends the appropriate {@link ServerMessages} keyword and appends any parameters.
 */
public class ServerMessageBuilder {
  ...
  public static String welcome(String player1) {
    return ServerMessages.WELCOME + " " + player1;
  }
  ...
  public static String start(String player1, String player2) {
    return ServerMessages.START + " " + player1 + " " + player2;
  }
  ...
  public static String turn(String player1) {
    return ServerMessages.YOUR_TURN + " " + player1;
  }
  ...
  public static String move(String player1, int x, int y) {
    return ServerMessages.MOVE + " " + player1 + " " + x + " " + y;
  }
  ...
  public static String winner(String player1) {
    return ServerMessages.WINNER + " " + player1;
  }
  ...
  public static String error(String message) {
    return ServerMessages.ERROR + " " + message;
  }
